...
?>
    ...
    <section class="food-menu">
        <div class="container">
			...
			<?php 
				//create sql to get foods based on catgeory
				$sql2 = "SELECT * FROM tbl_food WHERE categories_id = $category_id";
				//execute 
				$res2 = mysqli_query($conn, $sql2);
				$count2 = mysqli_num_rows($res2);
				//check foods is avalible or not
				if($count2 >0){
