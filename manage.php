				...
				<div class = "wrapper">
					...
					<br> <br> 
					 <?php
						if(isset($_SESSION['add'])){
							...
							unset($_SESSION['add']); //removing session messgae
						}
					...
					<table class= "tbl-full">
						...
						<?php
							...
							if($res == true){
								//count rows to check we have in database
								$count = mysqli_num_rows($res); //function to get all rows in databese
								if($count > 0){
										...
										?>
											<tr>
												...
												<td>
													...
													<a href="<?php echo SITEURL ;?>admin/update-ad.php?id=<?php echo $id?>"class ="btn-secondary">Update Admin</a>
													<a href="<?php echo SITEURL ; ?>admin/del-ad.php?id=<?php echo $id; ?>" class ="btn-danger">Delete Admin</a>
												</td>
											</tr>
										<?php
